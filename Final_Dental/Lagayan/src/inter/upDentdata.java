...
public class upDentdata extends JFrame {
    ...
    upDentdata() {
        ...
        //declaring the model of the table
        ...
        // Connect to database to make changes
        Object[][] appointments = {
        ...
        // Add selection listener to highlight selected row
